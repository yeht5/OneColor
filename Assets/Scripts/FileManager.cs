...
public class LevelData
{
	...
	public int step = 0;
	public string colorback = "0000000000000000000000000";
	public string colorleft = "0000000000000000000000000";
	public string colorright = "0000000000000000000000000";
	public string colortop = "0000000000000000000000000";
	public string colorbottom = "0000000000000000000000000";
